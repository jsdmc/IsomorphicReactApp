...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(IsomorphicReactApp.ReactConfig), "Configure")]

namespace IsomorphicReactApp
{
	public static class ReactConfig
	{
		public static void Configure()
		{
		    ...
		    ReactSiteConfiguration.Configuration
		                          .AddScript("~/js/dist/serverBundle.js");
		}
	}
}